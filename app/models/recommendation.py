...
class LegacyRecommendedProduct(BaseModel):
    """기존 방식의 추천된 상품 정보 """
    product: Product
...
class ProductRecommendationResponse(BaseModel):
    """기존 상품 추천 응답"""
    recommendations: List[LegacyRecommendedProduct]
    total_count: int
    processing_time_ms: float
...
class RecommendationMetadata(BaseModel):
    ...
    recommendation_method: str = Field(..., description="추천 방식 (profile_based/text_based)")
