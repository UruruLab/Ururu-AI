...
class GroupbuyInfo(BaseModel):
    ...
    current_participants: int = Field(0, description="현재 참여자 수")
    min_participants: int = Field(..., description="최소 참여자 수")
    max_participants: Optional[int] = Field(None, description="최대 참여자 수")
