...
class DBProductNotice(Base):
    ...
    capacity = Column(String(100), nullable=False, comment="용량")  # CAPACITY_MAX
    spec = Column(String(255), nullable=False, comment="제품 주요 사양")  # SPEC_MAX
    expiry = Column(String(100), nullable=False, comment="사용기한")  # EXPIRY_MAX
    usage_guide = Column(Text, nullable=False, comment="사용 방법")  # MySQL 예약어 회피용 컬럼명
    manufacturer = Column(String(100), nullable=False, comment="화장품 제조업자")  # MANUFACTURER_MAX
    responsible_seller = Column(String(100), nullable=False, comment="화장품책임판매업자")  # RESPONSIBLE_SELLER_MAX
    country_of_origin = Column(String(50), nullable=False, comment="제조국")  # COUNTRY_OF_ORIGIN_MAX
    ...
    customer_service_number = Column(String(20), nullable=False, comment="고객센터 번호")  # CUSTOMER_SERVICE_NUMBER_MAX
